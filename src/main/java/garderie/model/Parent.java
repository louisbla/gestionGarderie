...
public class Parent extends Personne implements Serializable {
    ...
    //Constructeur
    public Parent(String Nom, String Prenom, String Sexe, Date DateNaissance, String numSecu, ArrayList<PersonneAdresse> adresses, ArrayList<Filiation> listeEnf, String numTel, ArrayList<ParentFacture> fact) {
